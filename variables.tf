...
variable "interface" {
  description = <<-EOF
  A array of map describing the interfaces configuration. Keys of the map are the names and values are { subnet_id, private_ip_address, public_ip, enable_ip_forwarding }. Example:
  ```
  [
    {
      name                 = "mgmt"
...
variable "storage_uri" {
  description = "if boot_diagnostic_storage_uri is enabled, you will need to set this var"
  default     = ""
  type        = string
}
